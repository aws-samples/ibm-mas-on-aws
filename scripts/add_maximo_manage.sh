...
export ROLE_NAME=suite_app_install export MAS_APP_ID=manage && export MAS_APP_CHANNEL="8.4.x" && export MAS_WORKSPACE_ID=masdev && ansible-playbook ibm.mas_devops.run_role